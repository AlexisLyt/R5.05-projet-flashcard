...
async function seed() {
    try {
        ...
        const seedRevisions = [
			{
				idUser: insertedflashcards[0].id,
                idLevel: insertedflashcards[1].id,
                idFlashcard: insertedflashcards[0].id,
			},
			{
				idUser: insertedflashcards[0].id,
                idLevel: insertedflashcards[2].id,
                idFlashcard: insertedflashcards[1].id,
			},
			{
				idUser: insertedflashcards[0].id,
                idLevel: insertedflashcards[4].id,
                idFlashcard: insertedflashcards[2].id,
			},
			{
				idUser: insertedflashcards[1].id,
                idLevel: insertedflashcards[0].id,
                idFlashcard: insertedflashcards[0].id,
			},
			{
				idUser: insertedflashcards[1].id,
			...
			{
				idUser: insertedflashcards[2].id,
                idLevel: insertedflashcards[4].id,
                idFlashcard: insertedflashcards[0].id,
			},
			{
